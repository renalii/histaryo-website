...
<div class="container">
    <div class="card">
        ...
        <p class="lead">
            Your account was created with a temporary password. Choose a new password you will use from now on before opening the curator dashboard.
        </p>
