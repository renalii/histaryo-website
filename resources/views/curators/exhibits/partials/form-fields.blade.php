...
@if ($isEdit)
    <div class="exhibits-grid-2">
        <label for="{{ $prefix }}images">
            ...
            <input id="{{ $prefix }}images" type="file" name="images[]" accept="image/*" multiple>
        </label>
        <label for="{{ $prefix }}status">
            Status
            <select class="exhibits-status-select" id="{{ $prefix }}status" name="status" required>
...
@else
    <div class="exhibits-grid-2">
        <label for="{{ $prefix }}images">
            Images
            <input id="{{ $prefix }}images" type="file" name="images[]" accept="image/*" multiple required>
        </label>
        <label for="{{ $prefix }}status">
            Status
            <select class="exhibits-status-select" id="{{ $prefix }}status" name="status" required>
